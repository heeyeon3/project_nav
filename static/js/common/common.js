...
$(function() {
    ...
    user_pwd = CryptoJS.SHA256('default');
    ...
    $.ajax({
          ...
          success:function(data) {
            ...
            if(data.resultCode == "0"){
                ...
                alert(data.resultString)
                if(data.resultCode == "101" || data.resultCode == '100')
                {
...
var login2 = function(){
   ...
   $.ajax({
         url : 'https://www.selfood.co.kr/login/ad_index.json',
         data: { user_id: user_id, user_pwd: user_pwd_256 },
        //  data:form_data,
         type: 'post',
         dataType: 'json',
         contentType: false,
...
function manual(){
    ...
    window.open('/static/contents/common/Manual_NetVu_V1.0_Rev7.pdf');
}